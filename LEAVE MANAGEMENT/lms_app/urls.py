...
from lms_app.views import apply_leave, Inactive_permission, Inactive_role, active, active_permission, active_role, apply_leave, approve, create_leave_type, home, leave, list_view_Role, list_view_leave, login, signup_view, sinup, unapprove, update_appyleave, update_leave_type, updateuser, create_permission, create_role, update_Permssion, update_role, user_change_password, signout, Inactive, updateuser_reporting_manager, hod_dashboard
